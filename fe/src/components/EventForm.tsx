  ...
  return (
    <div>
      <form className="form-container">
        ...
        <label>
          Duration: <input type="number" step="1" {...register('duration')} />{' '}
          hours
        </label>
        ...
        <label>
          Time start: <input type="time" step="1" {...register('startTime')} />
        </label>
        ...
        <label>
          ...
          <input type="number" step="1" {...register('minParticipants')} />
        </label>
      </form>
